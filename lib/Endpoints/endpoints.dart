...
class api_class{
  Future retriveInfo(String access_token,String end_point,String user)async{//Funcion para obtener informacion de los Endpoints de GitHub
    String resource = '';
    switch(end_point){
      case'USER':
        resource = 'https://api.github.com/user';//EndPoint para obtener informacion del Usuario
        break;
      case'REPOS':
        resource= 'https://api.github.com/users/${user}/repos';//EndPoint de la in
    }
